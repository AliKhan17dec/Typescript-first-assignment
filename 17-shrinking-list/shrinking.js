var guestList = ["Amir", "Bilal", "Asad", "Usama", "Kashif", "Usman"];
...
guestList.forEach(function (guest) {
    console.log("Dear ".concat(guest, ", you are still cordially invited to dinner. We would be honored to have your presence."));
});
